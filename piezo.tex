...
%While the integrated Eurocard rack and backplane are convenient, they are not necessary to use the circuit design we provide -- one can equally supply $\pm\SI{15}{\volt}$ and program the microcontroller to fit whichever enclosure is at hand.
...
\hline
\rule{0pt}{2ex}$e_n$ (op-amp)  & \SI{26}{\micro\volt} & \SI{31}{\micro\volt}      \\
$i_n$ (op-amp)  &            \SI{51}{\micro\volt}     & \SI{73}{\micro\volt}      \\
