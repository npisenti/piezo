...
\begin{figure}[t]
\subfloat{
\includegraphics[width=\columnwidth]{calc/NoiseContrib.pdf}
}
...
\hline\hline
\rule{0pt}{2.5ex}\multirow{2}{*}{Noise source} & RMS Voltage                        \\
& (\SI{1}{\hertz}~--~\SI{100}{\kilo\hertz})\rule[-1ex]{0pt}{1ex} \\
\hline
\rule{0pt}{2ex}$e_n$ (op-amp)  & \SI{52}{\micro\volt}      \\
$i_n$ (op-amp)  & \SI{32}{\micro\volt}      \\
DAC             & \SI{75}{\micro\volt}       \\
Johnson-Nyquist & \SI{31}{\micro\volt}        \\ 
\hline
\rule{0pt}{2ex}\textbf{total (calculated)} & \SI{101}{\micro\volt}  \\
\hline\hline
\end{tabular*}
%\end{table}
}
...
\begin{figure}[h]
\subfloat{
%\includegraphics[clip,width=\columnwidth]{fig/TimeDomain.pdf}
}

\subfloat{
\includegraphics[clip,width=\columnwidth]{fig/LongTimeDomain.pdf}
}
